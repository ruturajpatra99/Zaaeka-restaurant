    ...
    <div className='section' id='recipe'>
        <div className='flex flex-col items-center'>
            ...
            <div className='grid lg:grid-cols-3 md:grid-cols-2 gap-8 mb-16'>
                {recipes.map((recipe) => {
                    return (
                        <div className='p-4 shadow-xl hover:shadow transition-all duration-300 cursor-pointer'
                        key={recipe.id}>
                            <img src={recipe.image} alt="" className='rounded-md mb-4'/>
                            <div className="flex items-center justify-between">
                                ...
                                <div className='flex items-center gap-2 font-bold'>
                                    <button>-</button>
                                    <span className='text-[0.85rem]'>{recipe.quantity}</span>
                                    <button>+</button>
